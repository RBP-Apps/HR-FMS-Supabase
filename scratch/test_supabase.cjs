...
async function checkTables() {
  try {
    ...
    if (err1) {
      ...
      console.log("follow_up exists, count:", followUp ? followUp.length : 0);
    }
    ...
    if (err2) {
      ...
      console.log("offer_letters exists, count:", offerLetters ? offerLetters.length : 0);
    }
    ...
    if (err3) {
      ...
      console.log("enquiry exists, count:", enquiry ? enquiry.length : 0);
    }
  } catch (e) {
