  ...
  const handleAfterLeavingClick = async (item) => {
    ...
    try {
      ...
      setFormData({
        ...
        chequeHandover: data.cheque_handover || false
      });
    ...
    try {
      ...
      const updatePayload = {
        ...
        remove_benefit_enrollment: formData.removeBenefitEnrollment,
         cheque_handover: formData.chequeHandover   // ✅ ADD THIS
      };
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-indigo-600">After Resignation Work</h1>
      </div>
            ...
            <table className="min-w-full divide-y divide-white">
              ...
              <tbody className="divide-y divide-white">
                {tableLoading ? (
                  ...
                  <tr>
                    <td colSpan="7" className="px-6 py-12 text-center">
                      <p className="text-gray-500">No pending after resignation work found.</p>
                    </td>
                  </tr>
                )}
              </tbody>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg shadow-lg w-full max-w-2xl">
            <div className="flex justify-between items-center p-6 border-b border-gray-200">
              <h3 className="text-lg font-medium text-gray-700">After Resignation Work Checklist</h3>
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
              ...
              <div className="space-y-3">
                ...
                {[
                  ...
                  { key: 'chequeHandover', label: 'Cheque Handover (चेक सौंपना)' }
                ].map((item) => (
