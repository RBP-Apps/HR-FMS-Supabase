...
const CallTracker = () => {
  ...
  const visibleColumns = [
    'Indent No.', 'Company Name', 'Candidate Enquiry No.', 'Applying For Post',
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-indigo-600">Call Tracker</h1>
      </div>
      ...
      <div className="bg-white rounded-lg shadow overflow-hidden">
        ...
        <div className="p-6">
          {activeTab === "pending" && (
            ...
            <div className="overflow-auto max-h-[400px]">
              <table className="min-w-full divide-y divide-gray-200">
                ...
                <thead className="bg-indigo-600 sticky text-center text-white top-0 z-10 text-nowrap">
                  <tr>
          ...
          {activeTab === "history" && (
            <div className="overflow-auto max-h-[400px]">
              <table className="min-w-full divide-y divide-gray-200">
                <thead className="bg-indigo-600 text-white sticky top-0 z-50 text-center text-nowrap">
                  <tr>
                    <th className="sticky top-0 left-0 z-50 bg-indigo-600 px-6 py-3 text-xs font-medium text-white uppercase min-w-[160px] border-r">
                      Progress
                    </th>
                    <th className="sticky top-0 left-[160px] z-50 bg-indigo-600 px-6 py-3 text-xs font-medium text-white uppercase min-w-[100px] border-r">
                      Action
                    </th>                    <th className="px-6 py-3  text-xs font-medium  uppercase">Indent No.</th>
                    <th className="px-6 py-3 text-xs font-medium uppercase">
                      Company Name
                    </th>
                    <th className="px-6 py-3  text-xs font-medium  uppercase">Candidate Enquiry No.</th>
                    <th className="px-6 py-3  text-xs font-medium  uppercase">Applying For Post</th>
                    <th className="px-6 py-3  text-xs font-medium  uppercase">Department</th>
                    <th className="px-6 py-3  text-xs font-medium  uppercase">Candidate Name</th>
                    <th className="px-6 py-3  text-xs font-medium  uppercase">Phone</th>
                    <th className="px-6 py-3  text-xs font-medium  uppercase">Email</th>
                    <th className="px-6 py-3  text-xs font-medium  uppercase">Resume</th>
                    <th className="px-6 py-3  text-xs font-medium  uppercase">Status</th>
                    <th className="px-6 py-3  text-xs font-medium  uppercase">Candidate Says</th>
                    <th className="px-6 py-3  text-xs font-medium  uppercase">Next Date</th>
                    <th className="px-6 py-3  text-xs font-medium  uppercase">Timestamp</th>
                  </tr>
                </thead>
