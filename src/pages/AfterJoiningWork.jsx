...
import { Filter, Search, Clock, CheckCircle, X, XCircle } from "lucide-react";
...
const AfterJoiningWork = () => {
  ...
  setFormData((prev) => ({
    ...prev,
    checkSalarySlipResume: checked,
    offerLetterReceived: checked,
    welcomeMeeting: checked,
    biometricAccess: checked,
    officialEmailId: checked,
    assignAssets: checked,
    pfEsic: checked,
    companyDirectory: checked,
    pdoCheckbox: checked,
  }));
};
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-indigo-600  ">On Boarding</h1>
      </div>
      ...
      <div className="bg-white  rounded-lg shadow overflow-hidden">
        ...
        <div className="p-6">
          {activeTab === "pending" && (
            <div className="overflow-x-auto max-h-[500px] overflow-y-auto">
              <table className="min-w-full divide-y divide-white">
                <thead className="bg-indigo-600 text-white sticky top-0 text-center z-10 text-nowrap text-white">
                  <tr>
                  ...
                  {tableLoading ? (
                    ...
                    filteredPendingData.map((item, index) => (
                      <tr key={index} className="hover:bg-white">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                          {renderField(formatDOB(item.dateOfJoining))}
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
          ...
          {activeTab === "history" && (
            <div className="overflow-x-auto max-h-[500px] overflow-y-auto">
              <table className="min-w-full divide-y divide-white">
                <thead className="bg-indigo-600 text-white sticky text-center top-0 z-10 text-nowrap text-center">
                  <tr>
                    <th className="px-6 py-3  text-xs font-medium text-white uppercase tracking-wider">
                      Action
                    </th>
                  ...
                  {tableLoading ? (
                    ...
                    filteredHistoryData.map((item, index) => (
                      <tr key={index} className="hover:bg-white hover:">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                          {renderField(item.emailPassword ? '✓ Set' : '')}
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                          {renderField(item.laptop || '')}
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                          {renderField(item.mobile || '')}
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                          {renderField(item.vehicle || '')}
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                          {renderField(item.sim || '')}
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                          {renderField(item.pfNumber || '')}
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                          {renderField(item.esicNumber || '')}
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                          {renderField(item.agreementDocument ? (
                ...
                <div className="space-y-3">
                  <div className="flex items-center">
                    ...
                    >
                      ...
                      Company Agreement (कंपनी समझौता)
                    </label>
                  </div>
